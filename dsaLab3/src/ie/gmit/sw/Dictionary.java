...
public class Dictionary
{
	...
	/*
	 * This method is for demonstration purposes only and can be used to convert the
	 * List words into a String[] using a slow O(n^2) approach or an amortized O(1)
	 * method. Normally, you should use the stream() method to convert the list into
	 * an array as shown above in getSortedWords().
	 */
