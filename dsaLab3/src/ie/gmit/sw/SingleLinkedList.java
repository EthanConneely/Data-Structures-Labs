...
public class SingleLinkedList<E>
{
	...
	/*
	 * A list is an indexed structure. This method searches for and returns the ith
	 * node. The running time for this method is O(n), as the worst case for the
	 * index is the last element in the list. Any other method that calls this
	 * method will have a time complexity of O(n * other), where other is the
	 * running time of the other method.
	 */
	...
	{ // O(n)
		...
		if (index == 0)
		{ // No elements in list, so add first
			addFirst(item); // O(1)
		} else
		{
	...
	{ // Have to search for item => O(n) O(n)
		Node<E> node = head;
		while (node != null)
		{ // Start looping from the head of the list
